...
if accounting_file and appsos_values_file:
    ...
    df3['IdentificationNumber'] = df3['IdentificationNumber'].astype('int64')
    ...
    df6['AccountNumber'] = df6['AccountNumber'].astype(str)
    df6['IdentificationNumber'] = df6['IdentificationNumber'].astype(str)
